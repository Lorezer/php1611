<?php
    class Person{
        ...
        public function info(){
            ...
            if($this->getMother() != null){
                $result .= "<strong>"."Имя матери: ".$this->getMother()->getName()."</strong><br>";
            ...
            if($this->getFather() != null){
                $result .= "<strong>"."Имя отца: ".$this->getFather()->getName()."</strong><br>";
    ...
    $person7 = new Person("Vera", "Popova", 73); /*Дедушка от папы*/ 
    $person6 = new Person("Sergey", "Popov", 72); /*Бабушка от папы*/ 
    $person5 = new Person("Nadya", "Petrova", 68); /*Бабушка от мамы*/ 
    $person4 = new Person("Igor", "Petrov", 70); /*Дедушка от мамы*/ 
    $person3 = new Person("Ivan", "Ivanov", 35, $person7, $person6); /*Папа*/ 
    $person2 = new Person("Olga", "Ivanova", 40, $person5, $person4); /*Мама*/ 
    $person1 = new Person("Alex", "Ivanov", 10, $person2, $person3); /*Сын*/ 
    echo $person2->info();
